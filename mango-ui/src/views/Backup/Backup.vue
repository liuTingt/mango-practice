<template>
    <!-- 备份还原界面 -->
    <!-- 添加 :modal-append-to-body="false" 防止出现弹框被遮罩层挡住 -->
    <el-dialog :title="$t('common.backupRestore')" width="40%" :visible.sync="backupVisible" :close-on-click-modal="false" :model="false" :modal-append-to-body="false">
