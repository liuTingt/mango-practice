    ...
    <div class="page-container">
        ...
        <div class="menu-container" :v-if="true">
            ...
            <div style="float:right; padding-right:15px; padding-top:4px; padding-bottom:4px">
                <kt-button :label="$t('action.reset')" perms="sys:role:edit" type="primary"
                    @click="resetSelection" :disabled="this.selectRole.id == null"></kt-button>
                <kt-button :label="$t('action.submit')" perms="sys:role:edit" type="primary"
                    @click="submitAuthForm" :disabled="this.selectRole.id == null" :loading="authLoading"></kt-button>
            </div>
        </div>
    </div>
</template>
    ...
    methods: {
        ...
        submitAuthForm() {
            ...
            if('admin' == this.selectRole.name) {
                this.$message({message: '超级管理员拥有额所有菜单权限，不允许修改！', type: 'error'})
                return 
            }
